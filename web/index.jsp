  ...
  <body>
    ...
    <div class="preloader">
      <div class="preloader-body">
        ...
        <h2 class="preloader-title">Cargando</h2>
      </div>
    </div>
    <div class="page">
      <!-- Page Header-->
     ...
     <section class="section section-full section-inset-1 bg-default text-center bg-image background-position-1" id="home" style="background-image: url(../images/bg-image-1-1920x800.jpg)">
        <div class="container">
            <div class="subtitle-classic wow fadeInUp">Servicios</div>
          <h2><span class="d-inline-block wow fadeInLeft">¿Que servicio Necesita?</span> <span class="text-primary d-inline-block wow fadeInRight">FRSánchez96</span>
          </h2>
          <div class="row row-lg row-30">
            <div class="col-sm-6 col-md-4 wow blurIn" data-wow-delay=".2s" >
                <article class="project-classic box-md"><img src="images/farmacia_turno.jpg" alt="" id="ex"/>
                <div class="project-classic-caption">
                  <div>
                    <h4 class="project-classic-title"><a href="Farmacia.jsp">Farmacias de Turno</a></h4>
            ...
            <div class="col-sm-6 col-md-4 wow blurIn" data-wow-delay=".1s">
                <article class="project-classic box-md"><img src="images/tiempo.jpg" id="ex"/>
                <div class="project-classic-caption">
                  <div>
                    <h4 class="project-classic-title"><a href="Tiempo.jsp">Tiempo</a></h4>
                    <div class="project-classic-tag">CHILE</div>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-md-4 wow blurIn">
              <article class="project-classic box-md"><img src="images/sismologia.jpg" alt="" id="ex"/>
                <div class="project-classic-caption">
                  <div>
                    <h4 class="project-classic-title"><a href="Sismologia.jsp">Sismología</a></h4>
                    <div class="project-classic-tag">CHILE</div>
                  </div>
                </div>
              </article>
            ...
            <div class="col-sm-6 col-md-4 wow blurIn" data-wow-delay=".1s">
              <article class="project-classic box-md"><img src="images/tarjetabip.png" alt="" id="ex"/>
                <div class="project-classic-caption">
                  <div>
                    <h4 class="project-classic-title"><a href="SaldoBip.jsp">Tarjeta BIP</a></h4>
                    <div class="project-classic-tag">Saldo</div>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-md-4 wow blurIn" data-wow-delay=".2s">
              <article class="project-classic box-md"><img src="images/micro.jpg" alt="" id="ex"/>
                <div class="project-classic-caption">
                  <div>
                    <h4 class="project-classic-title"><a href="TiempoMicro.jsp">¿Cuanto le falta a la Micro?</a></h4>
                    <div class="project-classic-tag">Ingrece el número de paradero</div>
                  </div>
                </div>
              </article>
            </div>

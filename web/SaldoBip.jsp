...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="section section-inset-1 bg-default text-center bg-image background-position-1" id="home" style="background-image: url(images/TarjetaBip_Logo.jpg)">
        <div class="container">
          <div class="title-style-1-wrap">
            <div class="oh-desktop wow slideInLeft">
              <h1 class="title-style-1 wow slideInRight">Saldo Tarjeta BIP</h1>
            </div>
          </div>
        </div>
      </section>
                ...
                <table class="table table-striped table-bordered" cellspacing="0" width="50%">
                    <thead>
                        <tr>
                          ...
                          <th>Saldo tarjeta BIP</th>
                          <th>Ultima fecha utilizada</th>
                        </tr>
                    </thead>
                    <tbody id="resultado">
                    </tbody>

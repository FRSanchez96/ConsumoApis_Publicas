...
<html class="wide wow-animation" lang="en">
 ...
 <!-- Bootstrap CSS -->
    ...
    <link rel="stylesheet"  type="text/css" href="..\nwcss\datatables\DataTables-1.10.18\css\dataTables.bootstrap4.min.css">
  ...
  <body>
    ...
    <div class="page">
            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a class="brand" href="index.html"><img class="brand-logo-desktop" src="" alt="" width="192" height="94"/><img class="brand-logo-mobile" src="images/logo-default-384x130.png" alt="" width="192" height="65"/></a>
                  </div>
                </div>
      ...
      <section class="section section-inset-1 bg-default text-center bg-image background-position-1" id="home" style="background-image: url(images/Sismologia_Logo.jpg)">
        <div class="container">
          <div class="title-style-1-wrap">
            <div class="oh-desktop wow slideInLeft">
              <h1 class="title-style-1 wow slideInRight">Sismología CHILE</h1>
            </div>
          </div>
        </div>
      </section>
      <section class="section section-inset-1 bg-default text-center bg-image background-position-1" id="home" >
          ...
          <div class="container">
              <div class="section">
                  <button class="btn" id="sismologia">Cargar nuevos sismos</button>
                  <bR>
                  <bR>
                  <bR>
              </div>
          ...
          <script src="ApiSismologia.js"></script>
      </section>
      <!-- Contacts-->
          ...
          <div class="row row-30 justify-content-center">
            ...
            <div class="col-sm-6 col-md-4 wow blurIn" data-wow-delay=".1s">
              <article class="contacts-modern">
                ...
                <ul class="contacts-modern-list">
                  <li class="contacts-modern-link"><a href="mailto:#">mail@demolink.org</a></li>
    ...
    <!-- Scripts Tablas FRSanchez96 -->
    
     <!-- jQuery, Popper.js, Bootstrap JS -->
    <script src="..\nwcss\jquery\jquery-3.3.1.min.js"></script>
    <script src="..\nwcss\popper\popper.min.js"></script>
    <script src="..\ComsumoApis_Publicas\web\nwcss\bootstrap\css\bootstrap-grid.min.css"></script>
